    ...
    renderItem=({item,index})=>(
        <TouchableWithoutFeedback onPress={()=>this.getContent(item,index)}>
            <View style={[styles.item_wrap,this.state.selectedIndex==index?styles.select_border:'']}>
                ...
                <Text style={styles.item_info}>{item.phone}</Text>
                {
        ...
        return(
            <View>
                <View style={[styles.flex_space_between,styles.item_style]}>
                    <Text style={styles.item_title}>{this.props.title?this.props.title:'出单人'}</Text>
                    <View style={[styles.flex,styles.input_style]}>
                        <TextInput
                            style={[styles.flex,styles.input_font]}
                            onChangeText={this._changeText.bind(this)}
                            value={this.state.value}
                            placeholder={this.props.waiter?this.props.waiter:'请选择出单人姓名'}/>
                    </View>
