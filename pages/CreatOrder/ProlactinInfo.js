...
export default class ProlactinInfo extends Component{
        ...
        return(
                <View style={{flex:1,backgroundColor: '#fcfcfc'}}>
                    ...
                    <View style={[styles.flex_space_between,styles.item_style]}>
                        ...
                        <Text style={styles.item_content}>{info.cr_times}次</Text>
                    </View>
                    <View style={[styles.flex_space_between,styles.item_style]}>
                    ...
                    <View style={[styles.flex_space_between,styles.item_style]}>
                        ...
                        <Text style={styles.item_content}>{info.cr_price}元</Text>
                    </View>
                    <View style={[styles.flex_space_between,styles.item_style]}>
                    ...
                    <View style={[styles.flex_space_between,styles.item_style]}>
                        ...
                        <Text style={styles.item_content}>{info.cr_address==NaN?info.cr_address:''}</Text>
                    </View>
                    ...
                    <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:px2dp(17),marginTop:px2dp(30)}}>
