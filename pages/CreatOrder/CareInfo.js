...
export default class CareInfo extends Component{
                ...
                <View style={{flex:1,backgroundColor: '#fcfcfc'}}>
                    ...
                    <ScrollView>
                        ...
                        <View style={[styles.flex_space_between,styles.item_style]}>
                            ...
                            <Text style={[styles.item_content,styles.blue_color]}>{info.ph_days}天</Text>
                        </View>
                        <View style={[styles.flex_space_between,styles.item_style]}>
                            <Text style={styles.item_title}>服务单价:</Text>
                            <Text style={styles.item_content}>{info.ph_price}元</Text>
                        </View>
                        <View style={[styles.flex_space_between,styles.item_style]}>
                    ...
                    <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:px2dp(17),marginTop:px2dp(65)}}>
