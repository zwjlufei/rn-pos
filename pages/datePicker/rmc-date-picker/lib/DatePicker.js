...
var DatePicker = (function(_React$Component) {
    ...
    function DatePicker() {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(
            this,
            (DatePicker.__proto__ || Object.getPrototypeOf(DatePicker)).apply(this, arguments)
        );
        ...
        },
        {
            ...
            value: function getDefaultMinDate() {
                if (!this.defaultMinDate) {
                    this.defaultMinDate = this.getGregorianCalendar([2010, 1, 1, 0, 0, 0]);
                }
        ...
        },
        {
            ...
            value: function getDefaultMaxDate() {
                if (!this.defaultMaxDate) {
                    this.defaultMaxDate = this.getGregorianCalendar([2050, 1, 1, 23, 59, 59]);
                }
        ...
        },
        {
            ...
            value: function getGregorianCalendar(arg) {
                return new (Function.prototype.bind.apply(
                    Date,
                    [null].concat((0, _toConsumableArray3.default)(arg))
                ))();
            }
        },
        {
